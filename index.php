    ...
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="<?=SITE_TEMPLATE_PATH?>/img/1.jpg" style="height:100%;">
            <img class="img-fluid" src="<?=SITE_TEMPLATE_PATH?>/img/1.jpg" style="height:100%;" alt="">
       ...
       <div class="col-lg-4 col-sm-6">
        ...
        <div class="col-lg-4 col-sm-6">
          <a class="portfolio-box" href="<?=SITE_TEMPLATE_PATH?>/img/4.jpg" style="height: 100%;">
            <img class="img-fluid" src="<?=SITE_TEMPLATE_PATH?>/img/4.jpg" style="height: 100%;" alt="">
            <div class="portfolio-box-caption">
        ...
        <div class="col-lg-4 col-sm-6">
          <a class="portfolio-box" href="<?=SITE_TEMPLATE_PATH?>/img/6.jpg" style="height: 100%;">
